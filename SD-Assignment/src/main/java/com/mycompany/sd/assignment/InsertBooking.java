...
public class InsertBooking extends javax.swing.JFrame {
    ...
    public void connectAndInsert()
    {
        ...
        try
        {
            ...
            stmt.executeUpdate("INSERT INTO tbl_booking(Day, Month, Year, TableNumber, UserId) values ('"+txtDay.getText()+"', '"+(cmbMonth.getSelectedIndex()+1)+"', '"+(cmbYear.getSelectedIndex()+1)+"', '"+(cmbTableNumber.getSelectedIndex()+1)+"', '"+txtUserId.getText()+"')");           
            //close connection
            con.close();            
        }
        catch (Exception e)
